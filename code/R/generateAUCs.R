...
#------------------------- DEFINE FUNCTION -------------------#
######################################################################
get_results <- function(data, models, split_number, perm=T, outcome=NA, hyperparameters=NULL){
  ...
  results <- pipeline(data, models, split_number,outcome=outcome,perm=perm,hyperparameters=hyperparameters)
  # These results have
  # 1. cv_auc,
  # 2. test_auc
