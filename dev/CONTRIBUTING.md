...
This document was adapted from the [Tidyverse Contributing
guide](https://tidyverse.tidyverse.org/CONTRIBUTING.html).
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("SchlossLab/mikropml", fork = TRUE)`.
...
Code of
Conduct](http://www.schlosslab.org/mikropml/dev/CODE_OF_CONDUCT.md). By
