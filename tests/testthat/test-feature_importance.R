...
test_that("custom grouped features works", {
  ...
  expect_equal(
    ...
    data.frame(
      perf_metric = c(0.638605263157895, 0.596921052631579,  0.631842105263158,
                      0.628052631578947, 0.597105263157895, 0.635210526315789,
                      0.642552631578947, 0.635894736842105),
      perf_metric_diff = c(0.00876315789473692, 0.0504473684210527,
                           0.0155263157894737, 0.0193157894736843,
                           0.0502631578947369, 0.0121578947368421,
                           0.00481578947368433, 0.0114736842105263),
      names = structure(c(7L, 3L, 8L, 1L, 6L, 2L, 5L, 4L),
                        .Label = c("Otu00001", "Otu00004",
                                   "Otu00005|Otu00003|Otu00002", "Otu00006",
                                   "Otu00007", "Otu00008", "Otu00009",
                                   "Otu00010"), class = "factor"),
      method = c("glmnet", "glmnet", "glmnet", "glmnet", "glmnet", "glmnet",
                 "glmnet", "glmnet"),
      perf_metric_name = c("AUC", "AUC", "AUC", "AUC", "AUC", "AUC", "AUC", "AUC"),
      seed = c(2019, 2019, 2019, 2019, 2019, 2019, 2019, 2019))
    )
})
