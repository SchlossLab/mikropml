...
test_that("feature importances are correct", {
  expect_equal(
    ...
    structure(list(perf_metric = c(0.639105263157895, 0.644236842105263,
    ...
    ), perf_metric_diff = c(0.00826315789473686, 0.00313157894736845,
                            ...
                            0.0117631578947369), names = structure(c(9L, 5L, 10L, 1L, 8L,
                                                                                                     ...
                                                                                                     "Otu00010"), class = "factor"), method = c("glmnet", "glmnet",
                                                                                                                                                ...
                                                                                                                                                "glmnet"), perf_metric_name = c("AUC", "AUC", "AUC", "AUC", "AUC",
                                                                                                                                                                                "AUC", "AUC", "AUC", "AUC", "AUC"), seed = c(2019, 2019, 2019,
                                                                                                                                                                                                                             2019, 2019, 2019, 2019, 2019, 2019, 2019)), class = "data.frame", row.names = c(NA,
                                                                                                                                                                                                                                                                                                             -10L))
  )
})
