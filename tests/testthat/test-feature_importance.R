...
feat_imp <- structure(list(perf_metric = c(0.629157894736842, 0.605473684210526,
...
), perf_metric_diff = c(0.0182105263157896, 0.0418947368421053,
0.00857894736842102, 0.0106052631578948, 0.0179210526315789,
0.00950000000000006, 0.00481578947368433, 0.0552105263157895,
0.00768421052631585, 0.00984210526315799), names = structure(1:10, .Label = c("Otu00001",
"Otu00002", "Otu00003", "Otu00004", "Otu00005", "Otu00006", "Otu00007",
"Otu00008", "Otu00009", "Otu00010"), class = "factor"), method = c("glmnet",
"glmnet", "glmnet", "glmnet", "glmnet", "glmnet", "glmnet", "glmnet",
"glmnet", "glmnet"), perf_metric_name = c("AUC", "AUC", "AUC",
"AUC", "AUC", "AUC", "AUC", "AUC", "AUC", "AUC"), seed = c(2019,
...
0.640289473684211, 0.629868421052632), perf_metric_diff = c(0.0182105263157896,
0.0504473684210527, 0.0137631578947369, 0.00826315789473686,
0.00494736842105259, 0.0505263157894738, 0.00707894736842096,
0.0175000000000001), names = structure(1:8, .Label = c("Otu00001",
"Otu00002|Otu00003|Otu00005", "Otu00004", "Otu00006", "Otu00007",
"Otu00008", "Otu00009", "Otu00010"), class = "factor"), method = c("glmnet",
"glmnet", "glmnet", "glmnet", "glmnet", "glmnet", "glmnet", "glmnet"
), perf_metric_name = c("AUC", "AUC", "AUC", "AUC", "AUC", "AUC",
"AUC", "AUC"), seed = c(2019, 2019, 2019, 2019, 2019, 2019, 2019,
2019)), row.names = c(NA, -8L), class = "data.frame")
  )
})
