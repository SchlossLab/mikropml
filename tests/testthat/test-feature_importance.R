...
test_that("feature importances are correct when tibbles used", {
  ...
  expect_equal(
    ...
    structure(list(perf_metric = c(
      ...
      0.0182105263157895, 0.0418947368421052,
      0.00857894736842102, 0.0106052631578948, 0.017921052631579, 0.00949999999999995,
      0.00481578947368422, 0.0552105263157895, 0.00768421052631574,
      0.00984210526315787
    ), pvalue = c(
      0.207920792079208, 0.0792079207920792,
      0.188118811881188, 0.376237623762376, 0.386138613861386, 0.356435643564356,
      0.287128712871287, 0.118811881188119, 0.217821782178218, 0.435643564356436
    ), lower = c(
      0.581578947368421, 0.531578947368421, 0.618421052631579,
      0.581578947368421, 0.494736842105263, 0.594736842105263, 0.623684210526316,
      0.521052631578947, 0.623684210526316, 0.555263157894737
    ), upper = c(
      0.668421052631579,
      0.657894736842105, 0.652631578947368, 0.694736842105263, 0.718421052631579,
      0.678947368421053, 0.657894736842105, 0.660526315789474, 0.652631578947368,
      0.721052631578947
    ), feat = structure(1:10, levels = c(
      "Otu00001",
      "Otu00002", "Otu00003", "Otu00004", "Otu00005", "Otu00006", "Otu00007",
...
test_that("custom grouped features works", {
  ...
  expect_equal(
    ...
    structure(list(perf_metric = c(
      ...
      0.64028947368421, 0.629868421052632
    ), perf_metric_diff = c(
      0.0182105263157895,
      0.0504473684210526, 0.0137631578947368, 0.00826315789473686,
      0.00494736842105259, 0.0505263157894736, 0.00707894736842107,
      0.0175
    ), pvalue = c(
      0.207920792079208, 0.257425742574257, 0.326732673267327,
      0.366336633663366, 0.336633663366337, 0.0891089108910891, 0.207920792079208,
      0.326732673267327
    ), lower = c(
      0.581578947368421, 0.463157894736842,
      0.58421052631579, 0.6, 0.623684210526316, 0.523684210526316,
      0.623684210526316, 0.560526315789474
    ), upper = c(
      0.668421052631579,
      0.7, 0.678947368421053, 0.668421052631579, 0.657894736842105,
      0.671052631578947, 0.652631578947368, 0.702631578947368
    ), feat = structure(1:8, levels = c(
      "Otu00001",
