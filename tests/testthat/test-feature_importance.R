...
names = structure(1:10, .Label = c("Otu00001",
...
0.640289473684211, 0.629868421052632), perf_metric_diff = c(0.0182105263157895,
0.0504473684210527, 0.0137631578947369, 0.00826315789473686,
0.0049473684210527, 0.0505263157894738, 0.00707894736842107,
0.0175000000000001), pvalue = c(0.17, 0.24, 0.27, 0.3, 0.26,
0.08, 0.11, 0.3), names = structure(1:8, .Label = c("Otu00001",
