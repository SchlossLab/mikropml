...
test_that("feature importances are correct", {
  ...
  expect_equal(
    ...
    structure(list(perf_metric = c(0.629157894736842, 0.605473684210526,
    ...
    perf_metric_diff = c(0.0182105263157895, 0.0418947368421053,
    ...
    pvalue = c(0.237623762376238,
               ...
               0.435643564356436),
    lower = c(0.581578947368421, 0.531578947368421,
    ...
    upper = c(0.668421052631579, 0.657894736842105, 0.652631578947368,
    ...
    names = structure(1:10, levels = c("Otu00001",
...
test_that("custom grouped features works", {
  ...
  expect_equal(
    ...
    structure(list(perf_metric = c(0.629157894736842, 0.596921052631579,
                                   0.633605263157895, 0.639105263157895,
                                   0.642421052631579, 0.596842105263158,
                                   0.640289473684211, 0.629868421052632),
                   perf_metric_diff = c(0.0182105263157895,
                                       0.0504473684210527, 0.0137631578947369,
                                       0.00826315789473686,
                                       0.0049473684210527, 0.0505263157894738,
                                       0.00707894736842107,
                                       0.0175000000000001),
                   pvalue = c(0.237623762376238, 0.257425742574257,
                           0.336633663366337, 0.366336633663366,
                           0.336633663366337, 0.0891089108910891,
                           0.207920792079208, 0.336633663366337),
                   lower = c(0.581578947368421,
                            0.463157894736842, 0.58421052631579, 0.6, 0.623684210526316,
                            0.523684210526316, 0.623684210526316, 0.560526315789474),
                   upper = c(0.668421052631579,
                            0.7, 0.678947368421053, 0.668421052631579,
                            0.657894736842105,
                            0.671052631578947, 0.652631578947368,
                            0.702631578947368),
                   names = structure(1:8,
                                     levels = c("Otu00001",
                                                "Otu00002|Otu00003|Otu00005",
                                                "Otu00004", "Otu00006",
                                                "Otu00007",
                                                "Otu00008", "Otu00009",
                                                "Otu00010"),
                   ...
                   perf_metric_name = c("AUC", "AUC", "AUC", "AUC", "AUC",
                                        "AUC", "AUC", "AUC"),
                   seed = c(2019, 2019, 2019, 2019, 2019, 2019, 2019,
                            2019)),
