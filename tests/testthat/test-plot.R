...
test_that("get_hp_performance works", {
  print(get_hp_performance(otu_mini_results1$trained_model)$dat)
  expect_equal(get_hp_performance(otu_mini_results1$trained_model), list(dat = structure(list(
    alpha = c(0L, 0L, 0L, 0L, 0L, 0L),
    lambda = c(1e-04, 0.001, 0.01, 0.1, 1, 10), AUC = c(
      0.584072076297686,
      0.584072076297686, 0.583446685428393, 0.582211538461538,
      0.58390009380863, 0.583763289555972
    )
  ), row.names = c(
    NA,
    6L
...
test_that("combine_hp_performance works", {
  expect_equal(combine_hp_performance(list(otu_mini_results1$trained_model, otu_mini_results1$trained_model)), list(dat = structure(list(alpha = c(
    ...
    0.584072076297686, 0.584072076297686,
    0.583446685428393, 0.582211538461538, 0.58390009380863, 0.583763289555972,
    0.584072076297686, 0.584072076297686, 0.583446685428393, 0.582211538461538,
    0.58390009380863, 0.583763289555972
