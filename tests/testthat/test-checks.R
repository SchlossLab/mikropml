...
test_that("check_outcome_value works", {
  ...
  expect_error(check_outcome_value(test_df_novar, "outcome"),
               "A binary or multi-class outcome variable is required, but this dataset has")
  expect_warning(expect_null(check_outcome_value(test_df_numeric, "outcome")),
...
test_that("check_features works", {
  ...
  expect_warning(expect_true(is.null(check_features(test_df_empty))),
