...
test_that("preprocess_data works", {
  expect_equal(
    ...
    list(dat_transformed = structure(list(outcome = c(
      ...
      var1 = "var1", var8 = "var8", grp1 = c(
        "var4_1", "var3_yes",
        "var2_b", "var9_x", "var10_0"
      ), grp2 = c(
        "var2_c", "var7_1",
        "var9_y"
      ), grp3 = c("var10_1", "var2_a")
    ))
  )
  expect_equal(
  ...
  expect_equal(
    ...
    list(dat_transformed = structure(list(outcome = c(
      "normal", "normal",
      "cancer"
    ), var1 = c(1, 2, 3), var8 = c(5, 6, 5.5), grp1 = c(
      0,
      1, 0
    ), grp2 = c(0, 0, 1), grp3 = c(1, 0, 0)), row.names = c(
      NA,
      -3L
    ), class = c("tbl_df", "tbl", "data.frame")), grp_feats = list(
      var1 = "var1", var8 = "var8", grp1 = c(
  ...
  expect_equal(
    ...
    list(dat_transformed = structure(list(outcome = c(
      "normal", "normal",
      "cancer"
    ), var1 = c(0, 0.5, 1), var8 = c(0, 1, 0.5), grp1 = c(
      0,
      1, 0
    ), grp2 = c(0, 0, 1), grp3 = c(1, 0, 0)), row.names = c(
      NA,
  ...
  expect_equal(
    ...
    list(dat_transformed = structure(list(outcome = c(
      ...
      -0.707106781186547, 0.707106781186547,
      0
    ), var3_yes = c(0, 1, 0), var4_1 = c(0, 1, 0), var7_1 = c(
      1,
      1, 0
    ), var2_a = c(1, 0, 0), var2_b = c(0, 1, 0), var2_c = c(
      0,
      0, 1
    ), var9_x = c(0, 1, 0), var9_y = c(0, 0, 1), var10_0 = c(
      0,
      1, 0
    ), var10_1 = c(1, 0, 0), var5 = c(0, 0, 0), var6 = c(
      0, 0,
      0
