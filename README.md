...
> \![note\] xgboost \<= v1.7 required
>
> There is a bug in later versions of xgboost with caret. You will need
> to downgrade your xgboost version to \<= 1.7 if you wish to use
> xgbTree. See \#352 for more details.
