...
By default, we provide `run_ml()` with pre-determined parameters and hyperparameters.
As you can see the `alpha` is set to 0.
This is to make sure we are running L2 regularization.
