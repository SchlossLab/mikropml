...
eval_big_chunks <- TRUE # whether to evaluate long-running chunks or "cheat" by just loading the data
```
...
```{r multi_seeds, eval = eval_big_chunks}
...
```{r multi_seeds_load, echo = FALSE, eval = !eval_big_chunks}
...
```{r multi_methods_seeds, eval = eval_big_chunks}
# NOTE: use more seeds for real-world data
...
```
```{r results_mtx, echo = FALSE, eval = !eval_big_chunks}
