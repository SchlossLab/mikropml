...
```{r multi_methods_seeds, eval = FALSE}
# NOTE: use more seeds for real-world data
...
Get sensitivity, specificity, and precision for all models.
...
sensspec_dat %>% 
    calc_mean_prc() %>% 
    plot_prc(baseline_precision = calc_baseline_precision(otu_data_preproc, 'dx', 'cancer'))
```
