...
Since I assume a lot of you won't read this entire vignette, I'm going to say this at the beginning. If the `preprocess_data` function is running super slow, you should consider parallelizing it so it goes faster! You can learn more about how to do that in `vignette(parallel)`
